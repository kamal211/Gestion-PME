...
$myRequet= "INSERT INTO `employe`( `nom`, `prénom`, `datenaissance`, `département`, ` salaire`, `fonction`, `photo`) VALUES('$matricule','$nom','$prénom','$date','$département','$salaire','$fonction','$photo')";
// $myRequet= "INSERT INTO employe( `nom`, `prénom`) VALUES('bakali','rachid')" ;/*(nom =:nom,prénom=:prénom)";*/
